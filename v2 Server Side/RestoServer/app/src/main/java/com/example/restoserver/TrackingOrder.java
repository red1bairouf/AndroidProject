...
import com.example.restoserver.Common.DirectionJSONParser;
    ...
    private boolean checkPlayService() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Toast.makeText(this, "Th device is not supported !", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
    ...
    private void displayLocation() {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            if (mLastLocation != null) {
                ...
                //Add marker in location and move camera
                ...
                //After marker for my location add one for the order one
